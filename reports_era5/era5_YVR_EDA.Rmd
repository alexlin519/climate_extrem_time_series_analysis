...
write.csv(df_3_yvr, "../output/era5_YVR_heatmap_3_dayHW.csv", row.names = FALSE)
...
# Save the updated dataframe to a file
write.csv(df_5_yvr, "../output/era5_YVR_heatmap_5_dayHW.csv", row.names = FALSE)
