...
```{r, echo=FALSE,warning=FALSE,message=FALSE}
plot_consecutive_dry_days(consec_precip_bymonth_path, start_year = 1937, end_year = 2024, step = 10)
```
</div>
<h3 onclick="toggleCollapsible(this);">
<!--TEXT SHOWS: -->
...
#### Plot the consecutive dry days for Kelowna, starting from 1938, Kelowna has data from 1899 to 2024.
```{r, echo=FALSE,warning=FALSE,message=FALSE}
plot_consecutive_dry_days(consec_precip_bymonth_path_Kelowna, start_year = 1938, end_year = 2024, step = 10)
