---
title: "Abbotsford heat wave analysis"
...
file_paths <- c( "../data/Abbotsford/Daily climate data.csv",
                 "../data/Abbotsford/Daily_Climate_Data_0.csv",
...
```{r, echo=FALSE,warning=FALSE,message=FALSE}
any(is.na(df$LOCAL_DATE))
#shows the row where LOCAL_DATE is na
ttyyy <- df[is.na(df$LOCAL_DATE),]
  df <- df[!is.na(df$LOCAL_DATE), ]
