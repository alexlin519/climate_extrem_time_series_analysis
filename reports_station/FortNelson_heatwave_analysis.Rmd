---
title: "FortNelson heat wave analysis"
...
plot_ehf(df_combined_ehf1,1966)
...
plot_ehf_all(df_combined_ehf1, start_year, end_year, 1966,station_name)
...
df_3_day_heatmap <- result_3d[[1]]
df_3_day_heatmap_95 <- result_3d[[2]]

result_35d <-  create_heatmap_filter_hw(combined_df, heat_wave_length = 5, start_date = '04-01', end_date = '10-31') 
df_5_day_heatmap <- result_35d[[1]]
df_5_day_heatmap_95 <- result_35d[[2]]
```
...
results_2def <- full_compare_ehf_and_percentile_specific(df_combined_ehf1, 1948)
...
results_2def <- full_compare_ehf_and_percentile_specific(df_combined_ehf1, 1980)
combined_plot_2021 <- results_2def[[1]]
left_full <- results_2def[[2]] 
left_full
```
...
results_2def <- full_compare_ehf_and_percentile_specific(df_combined_ehf1, 2004)
combined_plot_2021 <- results_2def[[1]]
left_full <- results_2def[[2]] 
left_full
```