...
station_filter_EHF_3d<-  line_segment_EHF_data_prepare(df_EHF_line_seg_3d, station_only = c("YVR_EHF", "Prince_George_EHF","Kelowna_EHF","Abbotsford_EHF","FortNelson_EHF"))
year_ranges <- create_year_ranges(1941, 2024, 5)
hline_data <- generate_temperature_plots_EHF("5 days long",station_filter_EHF_3d, year_ranges, station_colors)
```
...
station_filter_EHF_5d<-  line_segment_EHF_data_prepare(df_EHF_line_seg_5d, station_only = c("YVR_EHF", "Prince_George_EHF","Kelowna_EHF","Abbotsford_EHF","FortNelson_EHF"))
year_ranges <- create_year_ranges(1941, 2024, 5)
...
station_filter_EHF_5d  <- station_filter_EHF_5d %>% select(Year,DayOfYear,station,EHI_sig,EHI_accl,EHF)

# Ensure both data frames have the same columns
common_cols <- union(names(station_filter_EHF_5d), names(df_station_filter_5d))

# Add missing columns to station_filter_EHF_5d
missing_cols_station_filter_EHF_5d <- setdiff(common_cols, names(station_filter_EHF_5d))
station_filter_EHF_5d[missing_cols_station_filter_EHF_5d] <- NA
...
df_EHF_and_90th <- rbind(station_filter_EHF_5d,df_station_filter_5d)
```
YVR: 1937-2024
