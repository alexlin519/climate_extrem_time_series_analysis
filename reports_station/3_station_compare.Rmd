...
file_paths <- c("../output/Kamloops_heatmap_data.csv",       # Adding this file
                ...
                "../output/Penticton_heatmap_data.csv")             # Adding this file
...
<h3 onclick="toggleCollapsible(this);">
<!--TEXT SHOWS: -->
<b> 2.3 correlation between scatter plot of YVR_era5 vs YVR temp station.</b>
</h3>
<div style="display:none;"> 

Fit a Linear Model
Generate 95% Prediction Intervals as reference lines
```{r, echo=FALSE,message=FALSE}
...
<h3 onclick="toggleCollapsible(this);">
<!--TEXT SHOWS: -->
<b>3.1 line segment for 4 temp station, 3 day HW</b>
</h3>
<div style="display:none;"> 
...
df_station_filter<- line_segment_data_prepare(df_line_seg_3day, station_only = c("YVR", "Prince_George","Kamloops","Kelowna","Abbotsford","Penticton"))
year_ranges <- create_year_ranges(1940, 2024, 5)
hline_data <- generate_temperature_plots(df_station_filter, year_ranges, station_colors)
```
...
<h3 onclick="toggleCollapsible(this);">
<!--TEXT SHOWS: -->
<b>3.2 line segment for 4 temp station, 5 day HW</b>
</h3>
<div style="display:none;"> 
YVR:           1937-2024
Prince_George: 1942-2024
...
df_station_filter<- line_segment_data_prepare(df_filtered_line_seg_5d, station_only = c("YVR", "Prince_George","Kamloops","Kelowna","Abbotsford","Penticton"))
year_ranges <- create_year_ranges(1940, 2024, 5)
hline_data <- generate_temperature_plots(df_station_filter, year_ranges, station_colors)
...
df_station_yvr_comp <- line_segment_data_prepare(df_filtered_line_seg_5d, station_only = c("YVR", "YVR_30y_based"))
...
df_filtered_line_seg_3d <- df_filtered_line_seg_3d %>%
  filter(!is.na(station))
line_segment_plot(df_filtered_line_seg_3d, station_only = c("YVR_30y_based", "Prince_George","Kamloops","Kelowna"))+ geom_hline(aes(yintercept = as.numeric(Year)), color = "grey", linetype = "solid", alpha = 0.5)
