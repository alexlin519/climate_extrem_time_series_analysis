...
source("../R/read_data_Kelowna.R")  ## read data
df <- combined_data
...
```{r, echo=FALSE,message=FALSE, warning=FALSE, fig.path="Kelowna_heatwave_analysis_files/"}
...
<h3 onclick="toggleCollapsible(this);">
<!--TEXT SHOWS: -->
<b> plot hw analysis for all year </b>
</h3>
<div style="display:none;"> 
