...
# Define the path to save the CSV file
save_path <- "../output/Kamloops_heatmap_data.csv"
...
# Add the new column
df_3_yvr$station <- "Kamloops"
# Save the updated dataframe to a file
write.csv(df_3_yvr, "../output/Kamloops_heatmap_3_dayHW.csv", row.names = FALSE)
...
# Add the new column
df_5_yvr$station <- "Kamloops"
# Save the updated dataframe to a file
write.csv(df_5_yvr, "../output/Kamloops_heatmap_5_dayHW.csv", row.names = FALSE)
