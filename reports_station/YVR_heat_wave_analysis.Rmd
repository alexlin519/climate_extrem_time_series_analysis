---
title: "week3 YVR heat wave analysis"
...
file_paths <- c("../data/YVR1108447-daily1937to1964.csv",
                ...
                "../data/yvr Climate Daily Data.csv") #2024 nov data
                #it is the 2024 5 data:  "../data/YVR climate daily 2013 to 2024 copy.csv"
...
save_path <- "../output/YVR_percentiles.csv"
...
plot_ehf_all(df_combined_ehf1, start_year, end_year, 1961,station_name)
...
# Define the path to save the CSV file
save_path <- "../output/YVR_heatmap_data.csv"
...
# Add the new column
df_3_yvr$station <- "YVR"
# Save the updated dataframe to a file
write.csv(df_3_yvr, "../output/YVR_heatmap_3_dayHW.csv", row.names = FALSE)
...
# Add the new column
df_5_yvr$station <- "YVR"
# Save the updated dataframe to a file
write.csv(df_5_yvr, "../output/YVR_heatmap_5_dayHW.csv", row.names = FALSE)
...
# Add the new column
df_3_yvr_95$station <- "YVR"
# Save the updated dataframe to a file
write.csv(df_3_yvr_95, "../output/YVR_heatmap_3_dayHW_95.csv", row.names = FALSE)
...
# Add the new column
df_5_yvr_95$station <- "YVR"
# Save the updated dataframe to a file
write.csv(df_5_yvr_95, "../output/YVR_heatmap_5_dayHW_95.csv", row.names = FALSE)
```
