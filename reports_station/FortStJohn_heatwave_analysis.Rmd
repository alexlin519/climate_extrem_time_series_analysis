---
title: "FortStJohn heat wave analysis"
...
# Define file paths
file_paths <- c( "../data/FortStJoh/Daily climate data (4).csv",
                "../data/FortStJoh/Daily climate data (1).csv",
                "../data/FortStJoh/Daily climate data (2).csv",
                "../data/FortStJoh/Daily climate data (3).csv")

station_name <- "FortStJoh"
...
plot_ehf(df_combined_ehf1,2009)
plot_ehf(df_combined_ehf1,1942)
plot_ehf(df_combined_ehf1,1998)
# Example usage
...
plot_ehf_all(df_combined_ehf1, start_year, end_year, 2009,station_name)
plot_ehf_all(df_combined_ehf1, start_year, end_year, 1942,station_name)
plot_ehf_all(df_combined_ehf1, start_year, end_year, 1998,station_name)
...
results_3d <- create_heatmap_filter_hw(combined_df, heat_wave_length = 3, start_date = '04-01', end_date = '10-31') 
df_3_day_heatmap <- results_3d[[1]]
df_3_day_heatmap_95 <- results_3d[[2]]
results_5d <-  create_heatmap_filter_hw(combined_df, heat_wave_length = 5, start_date = '04-01', end_date = '10-31') 
df_5_day_heatmap <- results_5d[[1]]
df_5_day_heatmap_95 <- results_5d[[2]]
...
#do the same with _95
colnames(df_3_day_heatmap_95)[colnames(df_3_day_heatmap_95) == "Color_95"] <- "daily_max_temp"
df_3_day_heatmap_95$station <- station_name
save_path <- paste0("../output/", station_name, "_heatmap_3_dayHW_95.csv")
write.csv(df_3_day_heatmap_95, save_path, row.names = FALSE)

colnames(df_5_day_heatmap_95)[colnames(df_5_day_heatmap_95) == "Color_95"] <- "daily_max_temp"
df_5_day_heatmap_95$station <- station_name
save_path <- paste0("../output/", station_name, "_heatmap_5_dayHW_95.csv")
write.csv(df_5_day_heatmap_95, save_path, row.names = FALSE)
...
results_2def <- full_compare_ehf_and_percentile_specific(df_combined_ehf1, 2015)
combined_plot_2021 <- results_2def[[1]]
left_full <- results_2def[[2]] 
left_full
```
...
results_2def <- full_compare_ehf_and_percentile_specific(df_combined_ehf1, 1978)
combined_plot_2021 <- results_2def[[1]]
left_full <- results_2def[[2]] 
left_full
```